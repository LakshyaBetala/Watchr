...
function ZoneCanvas() {
  ...
  const trackedObjects = useDashboardStore(s => s.trackedObjects);
...
function AlertTicker() {
  const alerts = useDashboardStore(s => s.alertFeed);
...
export default function LiveCanvas() {
  const { systemStatus, kpiData, zoneOccupancyHistory, detectionConfHistory, connectTelemetryStream } = useDashboardStore();
